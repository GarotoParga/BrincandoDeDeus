...
public class SistemaSolar {
    ...
    public SistemaSolar(String nome) {
        ...
        sol = new Estrela("Sol", 1392680, 1989e27, 10000, 38800, 6);
        planetas = new ArrayList<>();

        // ===== PLANETAS E LUAS =====

        // Mercúrio (sem luas)
        Planeta mercurio = new Planeta("Mercúrio", 4879, 3300, "Rochoso", 0, sol);
        planetas.add(mercurio);

        // Vênus (sem luas)
        Planeta venus = new Planeta("Vênus", 12104, 4870, "Rochoso", 0, sol);
        planetas.add(venus);
        ...
        // Marte
        Planeta marte = new Planeta("Marte", 6792, 642, "Rochoso", 2, sol);
        new Lua("Fobos", 22, 9, marte);
        new Lua("Deimos", 12, 23, marte);
        planetas.add(marte);

        // Júpiter
        Planeta jupiter = new Planeta("Júpiter", 139822, 1898000, "Gasoso", 4, sol);
        ...
        // Saturno
        Planeta saturno = new Planeta("Saturno", 116464, 568300, "Gasoso", 5, sol);
        ...
        // Urano
        Planeta urano = new Planeta("Urano", 50724, 86810, "Gasoso", 5, sol);
        ...
        // Netuno
        Planeta netuno = new Planeta("Netuno", 49244, 102400, "Gasoso", 2, sol);
